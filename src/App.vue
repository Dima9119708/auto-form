...
import FormBASE from '@/examples/form-base.vue'
import FormLARGE from '@/examples/form-lg.vue'
import FormSM from '@/examples/form-sm.vue'
...
<template>
    ...
    <div
        ...
        class="mb-5 border-2 p-6 rounded-md min-w-[500px]"
    >
